...
public class UpdateCandidatoCommandValidatorTests
{
    private readonly UpdateCandidatoCommandValidator _validator = new();

    private static UpdateCandidatoCommand Valido(
        Guid? id = null,
        string nome = "João Silva",
        string email = "joao@example.com",
        string telefone = "11999990000") =>
        new(id ?? Guid.NewGuid(), nome, email, telefone);
    ...
    public async Task DeveRejeitarIdVazio()
    {
        ...
        Assert.Contains(result.Errors, e => e.PropertyName == "Id" && e.ErrorMessage == "Id do candidato é obrigatório.");
    }
