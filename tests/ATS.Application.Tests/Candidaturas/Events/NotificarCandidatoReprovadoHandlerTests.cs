...
public class NotificarCandidatoReprovadoHandlerTests
{
    private readonly NotificarCandidatoReprovadoHandler _handler;

    public NotificarCandidatoReprovadoHandlerTests()
    {
        _handler = new NotificarCandidatoReprovadoHandler(
            NullLogger<NotificarCandidatoReprovadoHandler>.Instance);
    }
    ...
    {
        var loggerMock = new Mock<ILogger<NotificarCandidatoReprovadoHandler>>();
        loggerMock
            .Setup(l => l.IsEnabled(It.IsAny<LogLevel>()))
            .Returns(true);
        var handler = new NotificarCandidatoReprovadoHandler(loggerMock.Object);
