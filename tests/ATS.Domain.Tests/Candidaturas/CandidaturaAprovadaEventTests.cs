...
public class CandidaturaAprovadaEventTests
{
        ...
        string candidaturaIdStr, string candidatoIdStr, string vagaIdStr, string? observacoes)
    {
        ...
        var evento = new CandidaturaAprovadaEvent(candidaturaId, candidatoId, vagaId, observacoes);
    ...
    {
        var evento = new CandidaturaAprovadaEvent(_candidaturaId, _candidatoId, _vagaId, null);
    ...
    [Theory]
    [InlineData("Aprovado com excelência")]
    [InlineData("")]
    [InlineData(null)]
    public void DevePreservarObservacoesExatamenteComoPassadas(string? observacoes)
    {
        var evento = new CandidaturaAprovadaEvent(_candidaturaId, _candidatoId, _vagaId, observacoes);
    ...
    {
        var ev1 = new CandidaturaAprovadaEvent(_candidaturaId, _candidatoId, _vagaId, null);
        var ev2 = new CandidaturaAprovadaEvent(_candidaturaId, _candidatoId, _vagaId, null);
